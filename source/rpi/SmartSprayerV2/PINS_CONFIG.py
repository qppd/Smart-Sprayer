...
# 50 cm distance from sensor = EMPTY (liquid far from sensor, 0L)
...
CONTAINER_HEIGHT = CONTAINER_EMPTY_DISTANCE - CONTAINER_FULL_DISTANCE  # 28 cm of usable fill height
