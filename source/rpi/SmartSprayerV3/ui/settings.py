...
class SettingsFrame(ctk.CTkScrollableFrame):
    ...
    def __init__(self, parent, hardware=None):
        ...
        # Use the shared singleton.  If a hardware instance is passed in from
        # the parent UI (preferred), use it directly; otherwise fall back to
        # the singleton factory.  Either way we NEVER open a second serial
        # connection, which used to reset the ESP32 via RTS/DTR toggling.
